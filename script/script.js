const services = {
    "Remote Legal Consultation": { url: "index.html", icon: "bx bx-cart-add" },
    "Mobile Office Consultation": { url: "development.html", icon: "bx bx-code-alt" },
    "Request to Establish a New Company": { url: "marketing.html", icon: "bx bx-megaphone" },
    "Internal Corruption Investigation": { url: "data-analysis.html", icon: "bx bx-line-chart" },
    "Corporate Legal Rescue": { url: "content-writing.html", icon: "bx bx-pencil" }
};
